---
title: "Análise sobre o banco Iris"
output: 
...
De acordo com o boxplot e o gráfico de barras para as sépalas, o comprimento das sépalas da espécie Setosa é, em média, menor que o das demais espécies, mas sua largura é maior.
Com relação às pétalas, podemos ver no scatterplot que ambas medidas da
espécie Setosa são bem menores que as das demais, e as da Versicolor são ligeiramente menores que as da Virgínica. Além disso,a espécie Virgínica é a que apresenta a maior variância dentre as três em todas as medidas, exceto na largura da sépala, cuja maior variância pertence à espécie Setosa.

De maneira geral, conclui-se que existe diferença entre o tamanho da espécie Setosa e das demais, principalmente com relação à pétala. Já as espécies Versicolor e Virgínica tem tamanhos mais próximos entre si, mas tanto a média quanto a mediana da Virgínica superaram as da Versicolor em todas as medidas.
</div>
